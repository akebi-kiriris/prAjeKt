        ...
        <div class="flex flex-wrap items-end justify-between gap-3">
          ...
          <div class="flex flex-wrap items-center gap-3 text-xs text-gray-600">
            <div>
              ...
              <select :value="selectedGanttTimeline" class="px-3 py-1.5 border border-gray-200 rounded-lg bg-white" @change="$emit('update:selected-gantt-timeline', ($event.target as HTMLSelectElement).value)">
            ...
            <div>
              ...
              <select :value="selectedGanttRange" class="px-3 py-1.5 border border-gray-200 rounded-lg bg-white" @change="$emit('update:selected-gantt-range', ($event.target as HTMLSelectElement).value as 'all' | '90d' | '30d')">
            ...
            <div>
              ...
              <select :value="selectedGanttViewMode" class="px-3 py-1.5 border border-gray-200 rounded-lg bg-white" @change="$emit('update:selected-gantt-view-mode', ($event.target as HTMLSelectElement).value as 'Day' | 'Week' | 'Month')">
