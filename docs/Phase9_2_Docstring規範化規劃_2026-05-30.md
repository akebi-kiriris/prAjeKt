...
1. 檔案位置：`docs/phase9_2_tool_entrypoints.md`（新建）。
2. 每個 service 至少列出：
   - `function_name`
...
1. 檔案位置：`docs/phase9_2_tool_schema_contracts.md`（新建）。
...
1. 檔案位置：`docs/phase9_2_error_semantics_matrix.md`（新建）。
2. 至少覆蓋：
   - `VALIDATION_ERROR`
   - `PERMISSION_DENIED`
   - `NOT_FOUND`
...
6. 完成三份前置文件：
   - `phase9_2_tool_entrypoints.md`
   - `phase9_2_tool_schema_contracts.md`
   - `phase9_2_error_semantics_matrix.md`
